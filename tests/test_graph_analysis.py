...
class TestFindPath:
    ...
    def simple_chain_netlist(self):
        """R1 --- Net1 --- R2 --- Net2 --- R3"""
        return {
            "components": {"R1": {"value": "1k"}, "R2": {"value": "2k"}, "R3": {"value": "3k"}},
            "nets": {
                "Net1": [{"component": "R1", "pin": "2"}, {"component": "R2", "pin": "1"}],
                "Net2": [{"component": "R2", "pin": "2"}, {"component": "R3", "pin": "1"}],
            },
        }
    ...
    def power_net_netlist(self):
        ...
        return {
            "components": {
                ...
                "U1": {
                    "lib_id": "Interface_USB:TS3USBCA410",
                    "value": "TS3USBCA410",
                    "footprint": "Package_DFN_QFN:UQFN-16_1.8x2.6mm_P0.4mm",
                    "description": "USB Type-C, SBU 3:1 multiplexer, 500MHz bandwidth, UQFN-16",
                    "lib": "Interface_USB",
                    "name": "TS3USBCA410",
                    "sheet_names": "/",
                },
...
class TestGetNeighborhood:
    ...
    def test_neighborhood_isolated_component(self, tmp_path):
        ...
        netlist = {"components": {"R1": {"value": "1k"}}, "nets": {}}
        graph = CircuitGraph(netlist, str(tmp_path))
...
class TestEdgeCases:
    ...
    def test_duplicate_connections(self, tmp_path):
        ...
        netlist_data = {
            "components": {"R1": {"value": "1k"}},
            "nets": {"Net1": [{"component": "R1", "pin": "1"}, {"component": "R1", "pin": "1"}]},
        }
        graph = CircuitGraph(netlist_data, str(tmp_path))
